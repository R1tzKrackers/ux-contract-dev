...
2. **作業方針**
   - 確認予定項目一覧
     - パス実在確認 / Before/After具体化 / 廃止対象特定 / 問題報告
...
「実行せよ」の指示を受けてから、パス確認を実行し結果を出力せよ。
...
パス確認完了時、`.phase-manager-history.yml` に以下を追記せよ：
...
| シナリオ | comment例 |
|----------|-----------|
| 全パス確認OK | `全パス確認OK、問題なし` |
| 問題あり | `パス不一致2件、issues.ymlに記録` |
